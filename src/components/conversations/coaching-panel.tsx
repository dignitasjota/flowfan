...
export function CoachingPanel({ conversationId, onClose }: Props) {
  ...
  return (
    <Modal
      ...
      labelledBy="coaching-modal-title"
      className="relative mx-4 flex max-h-[85vh] w-full max-w-2xl flex-col rounded-xl border border-gray-700 bg-gray-900 shadow-2xl"
    >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-gray-800 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h3 id="coaching-modal-title" className="text-base font-semibold text-white">Coaching IA</h3>
          </div>
